#ifndef Header_qplugin_dragoslav_plugin_core_interface
#define Header_qplugin_dragoslav_plugin_core_interface
...
#endif // Header_qplugin_dragoslav_plugin_core_interface
