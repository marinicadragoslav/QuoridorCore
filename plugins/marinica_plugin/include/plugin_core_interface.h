#ifndef Header_qplugin_marinica_plugin_core_interface
#define Header_qplugin_marinica_plugin_core_interface
...
#endif // Header_qplugin_marinica_plugin_core_interface
